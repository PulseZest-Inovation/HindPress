...
const Header = () => {
  return (
    <header className="-mt-20 flex justify-between items-center p-4 bg-white shadow-md w-full">
      <div className="flex items-center">
        <img src={logo} alt="Logo" className="h-10 mr-2" />
        <h1 className="text-lg font-semibold">Hind Press</h1>
      </div>
      <div className="flex items-center relative w-full max-w-lg">
        ...
        />
        <button className="px-4 py-2 bg-purple-600 text-white rounded-r-full hover:bg-purple-700 focus:outline-none">
          <FaSearch />
        </button>
      </div>
